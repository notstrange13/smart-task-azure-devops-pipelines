...
describe('Products Endpoints', () => {
    describe('GET /api/products', () => {
        ...
        it('should filter products by price range', async () => {
            const response = await request(app).get('/api/products?minPrice=100&maxPrice=300');
        ...
        it('should sort products by price ascending', async () => {
            const response = await request(app).get('/api/products?sort=price-asc');
    ...
    describe('GET /api/products/category/:category', () => {
        ...
        it('should return 404 for non-existent category', async () => {
            const response = await request(app).get('/api/products/category/NonExistentCategory');
    ...
    describe('PUT /api/products/:id', () => {
        it('should update existing product', async () => {
            ...
            const response = await request(app).put('/api/products/1').send(updates);
